...
void Window::display_grid(sf::RenderWindow& window) const {
...
int Window::count_neighbors(int m_origin, int n_origin) const {
    int neighbors = 0;
...
void Window::apply_rules(int neighbors, int m, int n) {
